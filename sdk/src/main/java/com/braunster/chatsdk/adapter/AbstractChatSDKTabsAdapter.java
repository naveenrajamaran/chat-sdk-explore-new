...
import com.braunster.chatsdk.activities.RideFragment;
...
public class AbstractChatSDKTabsAdapter extends FragmentPagerAdapter implements PagerSlidingTabStrip.IconTabProvider {
    ...
    protected final String[] titles = {"Conversations", "Chat Rooms", "Contacts"};

    protected ChatSDKBaseFragment[] fragments = new ChatSDKBaseFragment[] {ChatSDKConversationsFragment.newInstance(), ChatSDKThreadsFragment.newInstance(), ChatSDKContactsFragment.newInstance("ConvFragmentPage")};

    protected int[] icnns = new int[] {R.drawable.ic_action_contacts,R.drawable.ic_action_private, R.drawable.ic_action_public, R.drawable.ic_action_contacts};
