        ...
        listContacts.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                else
                {
                        ...
                        createAndOpenThreadWithUsers(groupname.getText().toString().trim(), getNetworkAdapter().currentUserModel(), listAdapter.getItem(position).asBUser());
        ...
        btnStartChat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(groupname.getText().toString().trim().equalsIgnoreCase("")) {
                    showAlertToast("Enter Group Name");
                    return;
                }
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (mode == MODE_NEW_CONVERSATION)
                        {
                            ...
                            createAndOpenThreadWithUsers(groupname.getText().toString().trim(), users);
