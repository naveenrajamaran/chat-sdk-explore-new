...
public class BDefines {
    ...
    public static String ServerUrl = "https://revsmarttech.firebaseio.com/" + BRootPath;

    /** The url that is used for the file uploads.*/
    public static String FirebaseStoragePath = "gs://revsmarttech.appspot.com";
    ...
    public static final class Keys{
        ...
        public static final String BMac = "mac";
        ...
        public static String RideGroup="ride_group";
