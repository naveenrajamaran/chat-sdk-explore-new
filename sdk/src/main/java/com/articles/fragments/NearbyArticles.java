 ...
 */
public class NearbyArticles extends Fragment {
    ...
    ArrayList<Boolean> nearby = new ArrayList<>();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        Log.i("onCreate()", "started nearbyarticles");
    ...
    public class DoRssFeedTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            Firebase refLocation = new Firebase("https://revsmarttech.firebaseio.com/testRoot/sharedlocation/"+ userString + "/");
            refLocation.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                     latitudeCurrent = Double.parseDouble(String.valueOf(dataSnapshot.child("latitude").getValue()));
                     longitudeCurrent = Double.parseDouble(String.valueOf(dataSnapshot.child("langitude").getValue()));
                }
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for (DataSnapshot articles : dataSnapshot.getChildren()) {
                        ...
                        latitude.add(Double.parseDouble(String.valueOf(articles.child("lat").getValue())));
                        longitude.add(Double.parseDouble(String.valueOf(articles.child("long").getValue())));
...
//            item.setLatitude(latitude.get(i));
//            item.setLongitude(longitude.get(i));
...
//            item.setIsturned(0);
    ...
    public void isNearby() {
        for(int i = 0 ; i<totalArticles; i++){
            Location.distanceBetween(latitudeCurrent,longitudeCurrent,latitude.get(i),longitude.get(i),dist);
            if(dist[0] <= 50000.0f){
                nearby.add(true);
            }
            else{
            ...
            Log.e("sdvdvdfvd",String.valueOf(nearby.get(i)));
